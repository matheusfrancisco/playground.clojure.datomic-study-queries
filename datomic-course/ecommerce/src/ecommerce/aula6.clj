...
(pprint @(db/adiciona-produtos! conn [computador, celular, calculadora, celular-barato, xadrez] "200.222.333.444"))
...
(pprint (db/todos-os-produtos-mais-barato (d/db conn)))
(pprint (db/todos-os-produtos-do-ip (d/db conn) "200.222.333.444"))
;(db/apaga-banco!)
